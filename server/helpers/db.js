...
const pool = mysql.createPool({ connectionLimit: config.db_poolsize, host: config.db_host, port: config.db_port, user: config.db_user, password: config.db_pass, database: config.db_name });
